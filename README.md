...
dependencies {
  implementation 'io.github.sttk:reasonedexception:0.3.0'
}
```
...
[mvn-img]: https://img.shields.io/badge/maven_central-0.3.0-276bdd.svg
[mvn-url]: https://central.sonatype.com/artifact/io.github.sttk/reasonedexception/0.3.0
